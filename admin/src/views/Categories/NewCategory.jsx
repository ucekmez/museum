...
import { APInewcategory, styles } from "variables/helpers";
...
class NewCategory extends React.Component {
  ...
  addnewCategory = () => { APInewcategory(this) }
          ...
          <GridItem xs={12} sm={12} md={12}>
            <Card>
              <CardHeader color="warning">
                <h4 className={classes.cardTitleWhite} style={{'color':'black'}}>Yeni Kategori</h4>
              ...
              <CardFooter>
                <Button fullWidth={true} onClick={this.addnewCategory} color="success">Onayla</Button>
              </CardFooter>
            </Card>
          </GridItem>
        </Grid>
